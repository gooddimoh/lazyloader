...
$loadProcessing = new LozadProcessing();


$loadProcessing->delTypeAttributeForJavascriptResource($content);
$loadProcessing->processVideo($content);
$loadProcessing->processBackground($content);
$loadProcessing->processImages($content);
$loadProcessing->processIframe($content);
