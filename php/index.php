...
class LozadProcessing
{
    ...
    private function getTagsWithBgUrlgetTagsWithBgUrl($content)
    {
        $tagsWithBgUrl = [];
...
$LozadProcessing = new LozadProcessing();

if ($_POST['delTypeAttributeForJavascriptResource']) {
    $LozadProcessing->delTypeAttributeForJavascriptResource();
}
if ($_POST['getEmptyImage']) {
    $LozadProcessing->processBackground();

}
if ($_POST['getLazyloadScriptBaseClass']) {
    $LozadProcessing->processIframe();
}
if ($_POST['addLazyloadClassToTheImgElement']) {
    $LozadProcessing->processVideo();

}
if ($_POST['getSkipImagesRegexLazyload']) {

}
if ($_POST['getContentImages']) {

}
if ($_POST['getLazyLoadVideoIFrameFromContent']) {

}
if ($_POST['getTagsWithBgUrlgetTagsWithBgUrl']) {

}
if ($_POST['processImages']) {

}
if ($_POST['processBackground']) {

}
if ($_POST['processIframe']) {
}

if ($_POST['processVideo']) {
